...
train0_1 = pickle.load(open("/Users/Chief/Desktop/LeapDeveloperKit_2.3.1+31549_mac/LeapSDK/lib/CS228/Del6/userData/Soccorsi_train0.p", "rb", 0))
test0_1 = pickle.load(open("/Users/Chief/Desktop/LeapDeveloperKit_2.3.1+31549_mac/LeapSDK/lib/CS228/Del6/userData/Soccorsi_test0.p", "rb", 0))
...
train7_1 = pickle.load(open("/Users/Chief/Desktop/LeapDeveloperKit_2.3.1+31549_mac/LeapSDK/lib/CS228/Del6/userData/Mardis_train7.p", "rb", 0))
test7_1 = pickle.load(open("/Users/Chief/Desktop/LeapDeveloperKit_2.3.1+31549_mac/LeapSDK/lib/CS228/Del6/userData/Mardis_test7.p", "rb", 0))
...
##########################################   
def ReshapeData(set1, set2, set3, set4, set5,set6, set7, set8, set9, set10, set11, set12, set13, set14, set15,set16, set17, set18):
    X = np.zeros((18000, 5*2*3), dtype="f")
    y = np.zeros(18000)
...
trainX, trainy = ReshapeData(trainM, trainN, train0, train3, train4, train5, train6, train7, train8, train9, train0_1, train3_1, train4_1, train5_1, train6_1, train7_1, train8_1,train9_1)
testX, testy = ReshapeData(testM, testN, test0, test3, test4, test5, test6, test7, test8, test9, train0_1, train3_1, train4_1, train5_1, train6_1, train7_1, train8_1, train9_1)
